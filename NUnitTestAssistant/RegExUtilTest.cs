...
namespace NUnitTestAssistant
{
    ...
    class RegExUtilTest
    {
        ...
        public static void TestTelNumValidate()
        {
            ...
            Expectations.Expect(RegExUtil.TelNumValidate("_λόλόόλόό0976513930"), Is.False, "Invalid: _λόλόόλόό0976513930");
        }
        [Test]
        public static void TestVinValidate()
        {
            ...
            Expectations.Expect(RegExUtil.VinValidate("WVWZZZ1KΰβοπZ5W201317"), Is.False, "Invalid: WVWZZZ1KΰβοπZ5W201317");
        }
        [Test]
