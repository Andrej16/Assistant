...
namespace AisTools
{
    ...
    /// <example>
    ///private void CreateExcelReport(bool isDepth = false)
    ///{
    ...
    /// }
    /// </example>
    public class ExcelFactory : IReporter
    {
        ...
        /// </remarks>        
        public ExcelFactory(IMessage message)
        {
            source = (DataTable)message.Properties["tableToExport"];
            startX = (int)message.Properties["startX"];
            startY = (int)message.Properties["startY"];
            Initialize();
        }
